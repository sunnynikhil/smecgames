...
void initializegame()
{
    ...
    system("cls");
    printf("\n\n\t\t---------------------------------------------------------------\n");
    printf("\t\tWelcome to SMEC playstation\n\n");
    printf("\t\t---------------------------------------------------------------\n\n");
    while(1)
    {
        printf("Here we have provide you some interesting games\n\nYou choose the game \n\n 1 ->for Snake game\n\n 2 ->for Pacman \n\n 3 ->for Quiz \n\n 4 for viewing highscore in these playstation\n\n 5 for exit from playstation\n\n enter your choice\n\n");
    scanf("%d",&ch);
    switch(ch)
    {
